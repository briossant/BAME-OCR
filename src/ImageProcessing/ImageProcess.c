...
void print_help(char *argv0) {
    ...
    printf(
        "cr, crop [a][b][c][d]    Crop between the 2 points (a, b) (c, d)\n");
    ...
    do {
                   ...
                   strcmp(arg, "gaussianblur") == 0) // GaussianBlur
        {
            res.argv[i] = 4;
                   ...
                   strcmp(arg, "bright") == 0) // Bright
        {
            res.argv[i] = 0;
        } else if (strcmp(arg, "ag") == 0 ||
                   strcmp(arg, "arroundgaussianblur") ==
                       0) // ArroundGaussianBlur
        {
            res.argv[i] = 5;
        } else if (strcmp(arg, "r") == 0 ||
                   strcmp(arg, "rotate") == 0) // Rotate
        {
            res.argv[i] = 7;
            arg = strtok(NULL, " ");
            if (arg == NULL) {
