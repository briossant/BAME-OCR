...
void print_help(char *argv0)
{
    ...
    printf("gn, greennb [a][b][c][d] Draw 1 between the 2 points (a, b) (c, d)\n"); // TODO: all the digits
}
...
int ImageProcess(uplet argv)
{
    ...
    for (int i = 0; i < argv.argc; i++)
    {
        ...
        {
            get_green_number(image_converted, 1, argv.p3.x+image_converted->w*argv.p3.y,  argv.p4.x+image_converted->w*argv.p4.y);
        }
    }
